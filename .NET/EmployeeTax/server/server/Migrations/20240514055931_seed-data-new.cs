    ...
    public partial class seeddatanew : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Main St, City, Country", 22, "2002-01-31", "Male", "Vishal Kumar", "ABCDE1234F", "admin@123", "1234567890", "admin" },
                    { 2, "123 Main St, City, Country", 21, "2002-01-31", "Male", "Vishal", "ABCDE1234F", "emp@123", "8459126643", "employee" }
                });

            migrationBuilder.InsertData(
                table: "TaxDeclarations",
                columns: new[] { "taxId", "LTA", "NPS", "PPF", "TDS", "anyOtherIncome", "bankFixedDeposit", "dateOfDeclaration", "empId", "financialYear", "higherEducationLoanInterest", "houseRent", "interestHousingLoan", "isFrozen", "isSubmitted", "lifeInsurancePremium", "mediClaim", "preventiveHealthCheckUp", "principalHousingLoan", "status", "sukanyaSamriddhiAccount", "tuitionFee" },
                values: new object[,]
                {
                    { 1, true, 30000m, 20000m, 25000m, 0m, 40000m, "2024-04-28", 1, 2025, 20000m, 20000m, 25000m, false, false, 25000m, 15000m, 10000m, 35000m, "drafted", 15000m, 30000m },
                    { 2, true, 30000m, 20000m, 25000m, 0m, 40000m, "2024-04-25", 2, 2024, 20000m, 20000m, 25000m, false, false, 25000m, 15000m, 10000m, 35000m, "drafted", 15000m, 30000m }
                });
        }
